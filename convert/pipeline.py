...
PIPELINE_POST_D = [
    ...
    # last weight edit is 7.5 (hands); 7.8 finalizes every vertex: cull dust,
    # limit 4 bones, normalize — mmd_tools export only truncates top-4 blindly.
    ("7.8", "object.sanitize_weights", "权重收尾(剔渣+4骨+归一)", {}, False),
